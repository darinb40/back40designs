...
<section className="border-t border-white/10 bg-black px-6 py-20 md:px-10">
  <div className="mx-auto max-w-4xl">
    ...
    <div className="mt-8 space-y-6 text-base leading-8 text-stone-300 md:text-lg">
      ...
      <p>
        Growing up, my grandfather — James E. McKeel, who we called
        “Papa Fuzzy” — always had a hat on. He was a baker, a hunter, a Cubs
        fan, and a hardworking man who loved his family deeply.
      </p>

      <p>
        He was one of the biggest influences in my life. The kind of man who
        didn’t need to say much for people to feel his presence. Strong. Steady.
        Real.
      </p>
      ...
      <p>
        This brand is about more than custom headwear. It’s about building
        something with meaning. Something honest. Something that reflects the
        people, places, and stories that matter most.
      </p>

      <p>
        Every patch, every design, and every hat carries that mindset — purpose
        over hype, quality over shortcuts, and story over noise.
      </p>
    </div>
