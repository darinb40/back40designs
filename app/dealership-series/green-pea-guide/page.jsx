...
// ── OBJECTION PLAYBOOK ───────────────────────────────────────────────
const objections = [
  { objection: "I'm just looking.", response: "Hey — you're actually my favorite customer. My easiest job is when somebody doesn't have to buy today. If you decide to, that's fine. Either way, I'm just here to help and there's no pressure on either one of us. Sound fair?" },
  { objection: "We're not buying anything today.", response: "I understand everybody must start somewhere. First you look. Then you find something you like. Then you find someone who will take care of you and make you an amazing deal. It's not a matter of IF you're going to buy, but WHEN — and WHEN is when the deal is right. Let me show you a quick 5-minute proposal I guarantee will be hard to say no to. Follow me inside." },
  ...
  { objection: "I have a few more cars I want to look at.", response: "Let's say you already checked out the other vehicles and mine was the last one. What would be the deciding factor in the end — the car itself, or the car you got the best deal on? So it's not a matter of IF you're going to buy, but WHEN — and WHEN is when the deal is right, right?" },
  { objection: "I never buy on my first stop.", response: "Not too long ago, customers had to visit 3 dealerships before buying. Now with all the information available online, the average customer only needs to visit one. It's not a matter of if you buy, but WHEN — and WHEN is when the deal is right. Let me show you a quick 5-minute proposal. In the end it's completely your decision. Come with me." },
  ...
  { objection: "I don't want to pay a doc fee.", response: "I understand. Do you have the paperwork from your last vehicle? I can tell you with certainty — you couldn't have driven off any lot without paying a doc fee. It's on every single vehicle you've ever purchased. Ours is only $129. Most stores in our area have over $1,000. It would actually cost you more to do business anywhere else." },
  { objection: "I don't have any money down.", response: "99% of my clients choose to put the down payment on a credit card — you can choose how and when to pay it off, you don't have to put anything down today. The banks like to see a little customer participation — it helps with better rates and approvals. Which card would you like to put it on?" },
  { objection: "I want my payoff for my trade.", response: "What you owe and what the vehicle is worth are two different things. If you owed nothing on it, would you want nothing for it? Of course not — you'd want what it's worth. So what you owe and what it's worth are two separate conversations." },
