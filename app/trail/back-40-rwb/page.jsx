...
export default function Back40LoopRWBPage() {
  ...
  return (
    <main className="relative w-full overflow-hidden bg-black text-white">
        ...
        if (window.ShopifyBuy && window.ShopifyBuy.UI) {
          ...
          window.ShopifyBuy.UI.onReady(client).then((ui) => {
            ui.createComponent('product', {
              id: '10286114013316',
              node: document.getElementById('product-component-back40rwb'),
      ...
      {/* ── TRAIL STATS ── */}
      <section className="px-6 py-8 md:px-16" style={{ backgroundColor: "#B22234" }}>
      ...
      <section id="get-yours" className="bg-[#0a0a0a] px-6 py-16 md:px-16 md:py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div id="product-component-back40rwb" className="flex justify-center" />
        </div>
      </section>
