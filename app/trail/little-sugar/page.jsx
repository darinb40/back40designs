...
export default function LittleSugarPage() {
  ...
  return (
    <main className="relative w-full overflow-hidden bg-black text-white">
      ...
      <style>{`
        ...
        #product-component-1777645145056 { width: 100% !important; max-width: 100% !important; }
        #product-component-1777645145056 iframe { width: 100% !important; max-width: 100% !important; }
      `}</style>
      ...
      <section className="relative overflow-hidden" style={{ minHeight: "420px" }}>
        ...
        <div className="relative z-10 px-6 py-20 md:px-16 md:py-24">
          <div className="mx-auto max-w-5xl">
            <p className="mb-10 text-center text-xs font-semibold uppercase tracking-[0.4em] text-[#c6a36b]">Trail Stats — Little Sugar</p>
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
              {[
                { stat: "50", label: "Miles of Trail" },
                { stat: "2021", label: "Fully Opened" },
                { stat: "8", label: "Tunnels Built" },
                { stat: "#1", label: "Climbing Per Mile in NWA" },
              ].map(({ stat, label }) => (
          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2 md:gap-20">
            ...
            <div>
              ...
              <div className="mt-6">
                ...
                <div id="product-component-1777645145056" className="w-full" />
              </div>
            </div>
